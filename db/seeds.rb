...
this is what I have as of now-", user_id: 2)
...
I have a Photo class that is used all over my app. A post can have a single photo. However, I want to re-use the polymorphic relationship to add a secondary photo.", user_id: 2)
